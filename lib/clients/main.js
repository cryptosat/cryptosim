...
class MainClient {
   ...
   *         satellite. As opposed to other methods in this client, the
   *         timestamp is not reported here as the public key is expected to
   *         change throughout the lifetime of the satellite.
   */
  getPublicRsaKey() {
