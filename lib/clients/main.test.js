...
test("test trx signing2", async () => {
  // eslint-disable-next-line
  const [client, service, sat, universe] = setupClient();
  universe.clock().advance(-30 * 60 * 1000);
  const signedTrx = await client.signTextTransaction2();
  expect(signedTrx).toEqual(
    "0x7947c68a62bf8eeae3eded92415ee04bace6c8cf3bfff456d4d0d01586e028b006b1d90671b627faf6b468fb90e3e56c004c16af7e373578abfc3c64b982ad671b"
  );
});
